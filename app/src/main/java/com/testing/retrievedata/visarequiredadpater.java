...
public class visarequiredadpater extends RecyclerView.Adapter<MyAdapter.MyViewHolder>{

    Context context;
    ArrayList<CountryVisaData> countryVisaDataArrayList;

    public visarequiredadpater(Context context,ArrayList<CountryVisaData> countryVisaDataArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter.MyViewHolder holder, int position) {
        ...
        holder.visa_free.setAdapter(new SimpleAdapter(context, countryVisaData.getVisaRequired(),R.layout.vsiarequiredlines,
