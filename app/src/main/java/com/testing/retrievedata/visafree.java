...
public class visafree extends AppCompatActivity {
    RecyclerView recyclerView2;
    ArrayList<CountryVisaData> countrydetailslist;
    visafreeadapter myAdapter2;
    FirebaseFirestore db;
    String countryName;
    TextView view1,view2,countryNAME;
    ProgressDialog progressDialog;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_visafree);
        progressDialog = new ProgressDialog(this);
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Fetching Data....");
        progressDialog.show();
        view1 = findViewById(R.id.txtvfcname);
        view2 = findViewById(R.id.txtvfpaidstatus);
        ...
        myAdapter2 = new visafreeadapter(visafree.this, countrydetailslist);
